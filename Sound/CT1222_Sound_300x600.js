...
lib.ssMetadata = [
		{name:"CT1222_Sound_300x600_atlas_P_", frames: [[302,0,300,250],[0,0,300,600],[0,602,300,250]]}
];
...
(lib.guarantee = function(mode,startPosition,loop) {
	...
	this.shape_2.setTransform(58.2,-232);
	...
	this.shape_3.setTransform(23.4,-232.2);
	...
	this.shape_4.setTransform(-24.6,-232);
	...
	this.shape_5.setTransform(-59.7,-232.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AguDAIAAidIh0jiIBnAAIA7CKIA8iKIBnAAIh0DiIAACdg");
	this.shape_6.setTransform(-91.8,-232.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AiNDSIAAmjIEbAAIAABcIi0AAIAABGICaAAIAABbIiaAAIAABKIC0AAIAABcg");
	this.shape_7.setTransform(93.9,-280.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAuDSIhJidIgiAAIAACdIhnAAIAAmjICkAAQAhABAcAKQAaALATAUQASASAKAZQAJAYAAAaQAAAogUAcQgTAagdAOIBbCwgAg9gfIA7AAQARAAANgNQAMgNAAgRQAAgQgMgNQgNgNgRAAIg7AAg");
	this.shape_8.setTransform(57.8,-280.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(18.1,-280.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AiNDSIAAmjIEbAAIAABcIi0AAIAABKICaAAIAABbIiaAAIAACig");
	this.shape_10.setTransform(-17.4,-280.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AiNDSIAAmjIEbAAIAABcIi0AAIAABGICaAAIAABbIiaAAIAABKIC0AAIAABcg");
	this.shape_11.setTransform(-53.3,-280.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AibDSIAAmjICrAAQBBAAAiAiQAkAgAAA4QgBAPgDAOQgEANgIAJQgOAVgQALIARAKIAPARQAJALAFAPQAGAQAAAUQAAA7glAgQglAig6AAgAg0B0IBEAAQATABAJgLQAJgLAAgQQAAgPgJgLQgJgKgTAAIhEAAgAg0gwIA+AAQATABAJgKQAJgLAAgOQAAgOgJgKQgJgKgTAAIg+AAg");
	this.shape_12.setTransform(-90.3,-280.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AhYCDIAAkFICxAAIAAA5IhwAAIAAAtIBfAAIAAA3IhfAAIAAAvIBwAAIAAA5g");
	this.shape_13.setTransform(99.6,-321.8);
...
(lib.CT1222_Sound_300x600 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(149,208.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(87).to({_off:false},0).to({x:150,y:481},4).wait(35).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(67).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(63).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(49).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.11,scaleY:1.11,x:150.1,y:518.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:481},0).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).wait(22).to({scaleX:1.53,scaleY:1.53,y:300},0).wait(22).to({regX:0.1,regY:0.1,scaleX:2.41,scaleY:2.41,x:151,y:499.3},0).wait(1).to({scaleX:2.6,scaleY:2.59,y:499.2},0).wait(1).to({scaleX:2.41,scaleY:2.41,y:499.3},0).wait(1).to({scaleX:2.6,scaleY:2.59,y:499.2},0).wait(1).to({scaleX:2.41,scaleY:2.41,y:499.3},0).wait(1).to({scaleX:2.6,scaleY:2.59,y:499.2},0).wait(1).to({scaleX:2.41,scaleY:2.41,y:499.3},0).to({_off:true},26).wait(278));
