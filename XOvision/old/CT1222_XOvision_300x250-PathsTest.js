...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/CT1222_XOvision_300x250_PathsTest_atlas_P_.png", id:"CT1222_XOvision_300x250_PathsTest_atlas_P_"}
	]
};
...
lib.ssMetadata = [
		{name:"CT1222_XOvision_300x250_PathsTest_atlas_P_", frames: [[0,0,300,250],[0,252,300,250],[0,504,300,250]]}
];
...
(lib.CT1222_XOvision_300x250_Deck = function() {
	this.spriteSheet = ss["CT1222_XOvision_300x250_PathsTest_atlas_P_"];
	this.gotoAndStop(0);
...
(lib.CT1222_XOvision_300x250PathsTest = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
